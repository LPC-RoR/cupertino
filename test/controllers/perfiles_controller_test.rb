...
class PerfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post perfiles_url, params: { perfil: { administrador_id: @perfil.administrador_id, email: @perfil.email } }
    end
  ...
  test "should update perfil" do
    patch perfil_url(@perfil), params: { perfil: { administrador_id: @perfil.administrador_id, email: @perfil.email } }
