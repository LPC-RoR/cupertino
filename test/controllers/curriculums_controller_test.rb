...
class CurriculumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post curriculums_url, params: { curriculum: { asignatura_base_id: @curriculum.asignatura_base_id, nivel_base_id: @curriculum.nivel_base_id } }
    end
  ...
  test "should update curriculum" do
    patch curriculum_url(@curriculum), params: { curriculum: { asignatura_base_id: @curriculum.asignatura_base_id, nivel_base_id: @curriculum.nivel_base_id } }
