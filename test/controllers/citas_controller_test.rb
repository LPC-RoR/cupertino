...
class CitasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cita" do
    assert_difference('Cita.count') do
      post citas_url, params: { cita: { documento_base_id: @cita.documento_base_id, referencia_base_id: @cita.referencia_base_id } }
    end
  ...
  test "should update cita" do
    patch cita_url(@cita), params: { cita: { documento_base_id: @cita.documento_base_id, referencia_base_id: @cita.referencia_base_id } }
